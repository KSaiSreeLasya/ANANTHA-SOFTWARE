      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 border border-white/10 rounded-2xl overflow-hidden">
          <div className="relative h-[400px] flex items-center justify-center p-12 bg-gradient-to-br from-blue-900/20 to-black">
             ...
             <h3 className="relative text-3xl font-bold tracking-widest uppercase">Our Story</h3>
          </div>
          <div className="p-12 flex flex-col justify-center bg-[#0d0d0d]">
          ...
          <div className="p-12 flex flex-col justify-center bg-[#0d0d0d] order-2 md:order-1">
          ...
          <div className="relative h-[400px] flex items-center justify-center p-12 bg-gradient-to-bl from-coral/10 to-black order-1 md:order-2">
             <div className="absolute inset-0 opacity-20 hover:opacity-40 transition-opacity overflow-hidden">
             ...
             <h3 className="relative text-3xl font-bold tracking-widest uppercase text-right">Experienced Leadership</h3>
          </div>
        </div>
      </div>
    </div>
