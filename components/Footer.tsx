...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-gradient-to-t from-white via-white to-white border-t border-slate-200 pt-24 pb-12 mt-auto" style={{boxShadow: 'inset 0 1px 0 rgba(255, 255, 255, 0.8)'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          <div className="space-y-8 animate-fade-in-up group" style={{animationDelay: '0.1s'}}>
            ...
            <p className="text-xs text-slate-700 leading-relaxed uppercase tracking-widest font-medium group-hover:text-slate-900 transition-colors duration-600">
               ANANTHA SOFTWARE SOLUTIONS<br />
              <span className="text-slate-600 text-[10px]">WeWork Rajapushpa Summit,</span><br />
              <span className="text-slate-600 text-[10px]">Financial District, Hyderabad,</span><br />
              <span className="text-slate-600 text-[10px]">Telangana 500032.</span>
            </p>
          </div>
          ...
          <div className="animate-fade-in-up" style={{animationDelay: '0.4s'}}>
            ...
            <div className="flex space-x-5 mb-10">
              <a href="https://www.linkedin.com/company/anantha-software/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full border-2 border-primary/40 flex items-center justify-center text-slate-600 hover:text-white hover:border-primary bg-gradient-to-br from-primary/12 to-primary/6 hover:from-primary/25 hover:to-primary/12 transition-all duration-500 transform hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/40 group active:scale-95 relative overflow-hidden">
              ...
              <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full border-2 border-primary/40 flex items-center justify-center text-slate-600 hover:text-white hover:border-primary bg-gradient-to-br from-primary/12 to-primary/6 hover:from-primary/25 hover:to-primary/12 transition-all duration-500 transform hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/40 group active:scale-95 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/0 via-white/15 to-primary/0 transform -translate-x-full group-hover:translate-x-full transition-transform duration-800"></div>
              ...
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full border-2 border-primary/40 flex items-center justify-center text-slate-600 hover:text-white hover:border-primary bg-gradient-to-br from-primary/12 to-primary/6 hover:from-primary/25 hover:to-primary/12 transition-all duration-500 transform hover:scale-110 hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/40 group active:scale-95 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-primary/0 via-white/20 to-primary/0 transform -translate-x-full group-hover:translate-x-full transition-transform duration-800"></div>
        ...
        <div className="pt-16 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center text-[10px] text-slate-600 uppercase tracking-widest space-y-5 md:space-y-0 animate-fade-in-up" style={{animationDelay: '0.5s'}}>
          ...
          <div className="flex space-x-8">
            <button onClick={() => onNavigate('privacy')} className="text-slate-600 hover:text-secondary transition-all duration-500 font-bold border-b-2 border-transparent hover:border-secondary px-2 py-1">Privacy Policy</button>
            <button onClick={() => onNavigate('terms')} className="text-slate-600 hover:text-secondary transition-all duration-500 font-bold border-b-2 border-transparent hover:border-secondary px-2 py-1">Terms</button>
          </div>
        </div>
      </div>
    </footer>
