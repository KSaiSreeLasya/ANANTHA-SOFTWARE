  ...
  return (
    <div className="relative min-h-[100vh] flex flex-col justify-center items-center overflow-hidden bg-gradient-to-b from-color-bg via-color-bg-light to-color-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center py-20">
        ...
        {/* Main Heading */}
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[1.1] mb-8 uppercase">
          <span className="block text-text group animate-fade-in-up" style={{animationDelay: '0.2s', animationDuration: '0.8s', marginBottom: '0.25rem'}}>
            ...
            <span className="inline-block ml-2 mr-2 text-gradient animate-gradient-shift" style={{backgroundSize: '200% 200%'}}>Excellence</span>
            In
          </span>
          <span className="block text-gradient animate-gradient-shift animate-fade-in-up" style={{animationDelay: '0.4s', animationDuration: '0.8s', backgroundSize: '200% 200%'}}>Engineering & Technology</span>
        </h1>
