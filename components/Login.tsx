...
const Login: React.FC<LoginProps> = ({ onNavigate, onAuthSuccess }) => {
  ...
  return (
    <div className="relative min-h-screen bg-white pt-32 pb-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <form onSubmit={handleLogin} className="space-y-7 bg-gradient-to-br from-secondary/14 to-secondary/6 rounded-3xl p-8 md:p-12 border border-secondary/40 backdrop-blur-xl relative overflow-hidden animate-fade-in-up" style={{animationDelay: '0.2s'}}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-4 bg-secondary text-white font-bold rounded-xl hover:bg-purple-600 transition-all duration-500 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-widest text-sm transform hover:scale-105 active:scale-95"
          >
