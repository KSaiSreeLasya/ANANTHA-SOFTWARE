      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-28">
          ...
          <div className="text-center">
            ...
            <h2 className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter" style={{letterSpacing: '-0.025em', lineHeight: '1.1', marginTop: '0.5rem', color: '#ffffff', opacity: '1', visibility: 'visible', display: 'block'}}>
