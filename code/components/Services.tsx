      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-28">
          ...
          <h2 className="animate-fade-in-up flex flex-col items-center justify-center" style={{letterSpacing: '-0.025em', lineHeight: '1.05'}}>
            ...
            <span className="text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter text-white mt-4" style={{background: 'linear-gradient(135deg, #ef4444, #dc2626)', padding: '16px 32px', borderRadius: '8px', display: 'inline-block'}}>Technology Solutions</span>
          </h2>
